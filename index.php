...
<html>
 <head>
  <title>To-Do List in PHP and Ajax</title>  
 ...
 <body>
  ...
  <br />
  <div class="container">
   <h1>To-Do List in PHP and Ajax</h1>
   <br />
       ...
       <form method="post" id="to_do_form">
        ...
        <div class="input-group">
         ...
         <div class="input-group-btn">
          <button type="submit" name="submit" id="submit" class="btn btn-success btn-lg"><span class="">Add</span></button>
         </div>
        </div>
       </form>
       <br />
